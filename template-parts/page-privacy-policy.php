...
<main id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="entry-header text-center">
        ...
        <?php the_title( '<h1 class="privacy-policy-title">', '</h1>'); ?>
...
<h2>Who we are</h2>
<p>Our website address is: http://localhost:8082/dilisis.</p>
...
<h3>Cookies</h3>
<p>If you leave a comment on our site you may opt-in to saving your name, email address and website in cookies. These are for your convenience so that 
you do not have to fill in your details again when you leave another comment. These cookies will last for one year.</p>
